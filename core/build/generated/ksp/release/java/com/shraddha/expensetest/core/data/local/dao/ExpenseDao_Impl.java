...
public final class ExpenseDao_Impl implements ExpenseDao {
  ...
  public ExpenseDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfExpenseEntity = new EntityInsertionAdapter<ExpenseEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `expenses` (`id`,`amount`,`category`,`description`,`date`) VALUES (nullif(?, 0),?,?,?,?)";
      }
      ...
      public List<ExpenseEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new ExpenseEntity(_tmpId,_tmpAmount,_tmpCategory,_tmpDescription,_tmpDate);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getExpensesBetweenDatesSync(final long startDate, final long endDate,
